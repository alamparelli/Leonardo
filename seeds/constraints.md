...
The sonnet has fourteen lines. This is arbitrary. It is also generative. Poets don't fight the form; they think *through* it. The constraint becomes a thinking tool, a structure that guides attention and reveals possibilities that would be invisible in formless space.

Engineers know this intuitively. Every bridge is a negotiation between load, span, materials, and budget. The constraints aren't obstacles to the solution—they *are* the solution. Remove them and you have nothing to solve.
